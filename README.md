...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/datetime-distance-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14713&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/datetime-distance-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `datetime-distance` can be installed with:

```
conda install datetime-distance
```

It is possible to list all of the versions of `datetime-distance` available on your platform with:
